...
void print(Head &&head, Tail &&...tail) {
  static_assert(is_printable_v<Head> || is_streamable_v<std::ostream, Head>,
...
template<typename Head, typename ...Tail>
void print(std::ofstream &out, Head &&head, Tail &&...tail) {
  static_assert(is_printable_v<Head> || is_streamable_v<std::ofstream, Head>,
...
template<typename Head, typename ...Tail>
void print(std::stringstream &out, Head &&head, Tail &&...tail) {
  static_assert(is_printable_v<Head> || is_streamable_v<std::stringstream, Head>,
